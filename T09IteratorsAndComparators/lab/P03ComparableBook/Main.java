...
public class Main {
    public static void main(String[] args) {
        ...
        if (bookOne.compareTo(bookTwo) < 0) {
            ...
            System.out.println("T09IteratorsAndComparators.lab.P04BookComparator.Book are equal");
        }
        ...
        if (bookTwo.compareTo(bookThree) < 0) {
            ...
            System.out.println(String.format("%s is before %s", bookThree.getYear(), bookTwo.getYear()));
        } else {
            System.out.println("T09IteratorsAndComparators.lab.P04BookComparator.Book are equal");
        }
    }
